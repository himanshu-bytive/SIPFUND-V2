...
function HamburgerMenu8Screen(props) {
                ...
                <View style={styles.main_box}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between", }}>
                        <View style={styles.start_date}>
                            ...
                            <View style={styles.amc}>
                                <Text style={styles.select2}>Select Start Date</Text>
                                <AntDesign name="right" size={15} />
                        ...
                        <View style={styles.start_date}>
                            ...
                            <View style={styles.amc}>
                                <Text style={styles.select2}>Select End Date</Text>
                                <AntDesign name="right" size={15} />
...
export default connect(mapStateToProps, undefined, mapDispatchToProps)(HamburgerMenu8Screen)