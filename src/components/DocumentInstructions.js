export default {
    ...
    AC: "An Investor form is being sent to your registered email id. Please download, sign and upload the document.",
    PIC: "Please take a selfie or upload passport size photo with clear background required for KYC registration.",
    ...
    SIGN: "Please complete the e-signature process to finalize your KYC registration. Follow the instructions to digitally sign the required document."
};
